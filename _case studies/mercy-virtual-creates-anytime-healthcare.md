...
<section class="section relative flex justify-between items-center flex-wrap p-0">
    ...
    <div class="bg-wwt-blue flex-auto flex justify-center py-lg pr-xl pr-sm no-overflow">
        <div class="icon-holder relative h-100 w-20">
            <svg id="coworkers" class="absolute" style="top: -1.5rem; width: 120px;" data-name="Isolation Mode" xmlns="http://www.w3.org/2000/svg"
...
<section class="section relative overflow-x overflow-y bg-gray-very-light pt-lg pb-md">
    <div class="container flex justify-center flex-wrap">
        ...
        <div class="flex mx-md mb-md justify-center">
            <a href="https://www.youtube.com/watch_popup?v=FXWhJ5WBPAs&showinfo=0" target="_blank" class="block dim" style="width: 300px;">
                <img class="mw-desktop mx-a my-0 block w-100" title="Mercy Virtual Data and Analytics" src="https://www2-dev.wwt.com/wp-content/uploads/2017/03/THUMB-big-data.jpg"
                    alt="Mercy Virtual Data and Analytics" /></a>
        </div>
    </div>
</section>

<section class="section relative overflow-x overflow-y bg-white py-xl">
    <div class="container">
        <h3 class="fs-lg fw-300 blue-alt left mt-0 mb-lg left mw-tablet mx-a">Explore our solutions</h3>
        <div class="flex justify-center flex-wrap">
            <div class="flex justify-between flex-wrap mx-sm mb-sm mt-sm">
                <a href="https://www2-dev.wwt.com/industry/healthcare/" class="block dim" style="width: 150px;">
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 170 170">
                        ...
                        <path id="_Compound_Path_" data-name="&lt;Compound Path&gt;" class="cls-2" d="M40.67,115.08h1v4h5.18v-4h1v9h-1v-4H41.69v4h-1Z"
                        />
                        <path class="cls-2" d="M48.39,124.56h-2v-4H42.19v4h-2v-10h2v4h4.18v-4h2Zm-1-1h0v0Zm-6.2,0h0v0Z" />
                        <path id="_Compound_Path_2" data-name="&lt;Compound Path&gt;" class="cls-2" d="M50.43,115.08h6.49V116H51.44v3.07h4.9V120h-4.9v3.14H57v.92H50.43Z"
                        />
                        <path class="cls-2" d="M57.48,124.56H49.93v-10h7.49v1.92H51.94v2.07h4.9v1.92h-4.9v2.14h5.54Zm-6.56-1h0v0Z" />
                        <path id="_Compound_Path_3" data-name="&lt;Compound Path&gt;" class="cls-2" d="M62.35,115h1l4.09,9H66.3l-1.05-2.37H60.36l-1.07,2.37h-1Zm2.5,5.76-2-4.58-2.05,4.58Z"
                        />
                        <path class="cls-2" d="M68.17,124.56H66l-1.05-2.37H60.68l-1.07,2.37H57.48l4.55-10h1.6Zm-6.64-4.29h2.55l-1.27-2.86Z" />
                        <path id="_Compound_Path_4" data-name="&lt;Compound Path&gt;" class="cls-2" d="M69.16,115.08h1v8h5.06v.94H69.16Z" />
                        <path class="cls-2" d="M75.73,124.56H68.66v-10h2v8h5.06Zm-6.07-1h0v0Z" />
                        <path id="_Compound_Path_5" data-name="&lt;Compound Path&gt;" class="cls-2" d="M78.19,116h-3v-.94h7.06V116h-3v8h-1Z" />
                        <path class="cls-2" d="M79.72,124.56h-2v-8h-3v-1.94h8.06v1.94h-3Zm-1-1h0l0-8Z" />
                        <path id="_Compound_Path_6" data-name="&lt;Compound Path&gt;" class="cls-2" d="M84.13,115.08h1v4h5.18v-4h1v9h-1v-4H85.15v4h-1Z"
                        />
                        <path class="cls-2" d="M91.85,124.56h-2v-4H85.65v4h-2v-10h2v4h4.18v-4h2Zm-1-1h0v0Zm-6.2,0h0v0Z" />
                        <path id="_Compound_Path_7" data-name="&lt;Compound Path&gt;" class="cls-2" d="M93.49,119.59v0A4.52,4.52,0,0,1,98,114.92a4.67,4.67,0,0,1,3.5,1.42l-.69.74A3.9,3.9,0,0,0,98,115.86a3.52,3.52,0,0,0-3.48,3.68v0A3.54,3.54,0,0,0,98,123.28a3.9,3.9,0,0,0,2.9-1.3l.67.66A4.68,4.68,0,0,1,98,124.21,4.48,4.48,0,0,1,93.49,119.59Z"
                        />
                        <path class="cls-2" d="M98,124.71a5,5,0,0,1-5-5.12v0a5,5,0,0,1,5-5.15,5.19,5.19,0,0,1,3.85,1.56l.36.34-1.38,1.48-.37-.35A3.39,3.39,0,0,0,98,116.36a3.22,3.22,0,0,0,0,6.42,3.41,3.41,0,0,0,2.56-1.16l.35-.33,1.37,1.35-.35.36A5.17,5.17,0,0,1,98,124.71Zm-2.59-8.35a4.15,4.15,0,0,0-1.42,3.2v0a4.08,4.08,0,0,0,1.78,3.47,4.41,4.41,0,0,1-.37-6.7Zm4.52-.56a4.83,4.83,0,0,1,.89.59h0A4.33,4.33,0,0,0,99.92,115.8Z"
                        />
                        <path id="_Compound_Path_8" data-name="&lt;Compound Path&gt;" class="cls-2" d="M106.68,115h1l4.09,9h-1.09l-1.05-2.37h-4.89l-1.07,2.37h-1Zm2.5,5.76-2-4.58-2.05,4.58Z"
                        />
            ...
            <div class="flex justify-between flex-wrap mx-sm mb-sm mt-sm">
                <a href="https://www2-dev.wwt.com/solution/networking/" class="block dim" style="width: 150px;">
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 170 170">
                        ...
                        />
                        <path class="cls-2" d="M87.09,123.61H85.47L83.23,117,81,123.61h-1.6l-3.73-10.53h2.23l2.34,6.81,2.24-6.83h1.6l2.24,6.83,2.33-6.81h2.19Zm-10-9.53,3,8.4-2.88-8.4Zm12.28,0L87.66,119l1.75-4.92Zm-6.05,0,1.2,3.56Z"
                        />
            ...
            <div class="flex justify-between flex-wrap mx-sm mb-sm mt-sm">
                <a href="https://www2-dev.wwt.com/solution/mobility/" class="block dim" style="width: 150px;">
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 170 170">
                        ...
                        />
                        <path id="_Compound_Path_4" data-name="&lt;Compound Path&gt;" class="cls-2" d="M84.87,112.5h1.07V122H84.87Z" />
